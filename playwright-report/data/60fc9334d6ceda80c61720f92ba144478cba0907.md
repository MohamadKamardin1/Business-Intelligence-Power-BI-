...
- Name: smoke.spec.ts >> Dashboard Smoke Tests >> should execute drill-through row clicks correctly
...
Call log:
  - navigating to "http://localhost:5173/branches", waiting until "load"
